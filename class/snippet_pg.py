...
cursor.execute( "INSERT INTO de13ma.testtable( id, val ) VALUES ( 1, 'ABC' )" )
conn.commit()
# Выполнение SQL кода в базе данных с возвратом результата
cursor.execute( "SELECT * FROM de13ma.testtable" )
...
cursor.executemany( "INSERT INTO de13ma.testtable( id, val ) VALUES( %s, %s )", df.values.tolist() )
